...
train_txt = 'TrainLabelTired4ch.txt'
x_train_savepath = './Datasets_npy/tired/x_train_4ch.npy'
y_train_savepath = './Datasets_npy/tired/y_train_4ch.npy'
def generated(txt):
	'''
...
checkpoint_save_path = './SavedModels/tired/4ch/checkpoint_ResNet18/ResNet18_4ch.ckpt'
...
file = open('./Output/tired/4ch/weights_ResNet18_4ch.txt','w')
...
plt.savefig('./Output/tired/4ch/ResNet18_4ch.png')